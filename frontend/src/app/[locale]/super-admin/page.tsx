...
import {
  ...
  Search, Plus, Trash2, Loader2, AlertCircle, Check, ShieldOff, ShieldCheck,
  UserX, KeyRound, RefreshCw, Settings2, TreePine,
} from 'lucide-react';
...
export default function SuperAdminPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10">
      ...
      {tab === 'overview' ? <OverviewTab /> : tab === 'users' ? <UsersTab /> : <RoomsTab />}
    </div>
  );
}
